...
dtm_model_predict<-function(trees, model, dsm, chm, predict_grid_by, k, type='response')
{
  ...
  segtree<-segtree[complete.cases(segtree_sub),]
  ...
  treepos_dtm<-cbind(treepos_xy, z=treepos_dtm, w=segtree$logsobel) # You can try playing arond with what you weight by ...
